...
for path in [ws_path, art_path]:
    ...
    old_byok_real = "![BYOK Setup](./assets/screenshots/byok-setup-v2.png)\n*Figure 2: The Bring-Your-Own-Key configuration panel for activating live Gemini AI intelligence.*"
    old_byok_real_art = "![BYOK Setup](/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/byok-setup-v2.png)\n*Figure 2: The Bring-Your-Own-Key configuration panel for activating live Gemini AI intelligence.*"
...
print("Reverted BYOK to placeholder again.")
