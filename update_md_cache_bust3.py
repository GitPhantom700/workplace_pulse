...
for path in [ws_path, art_path]:
    ...
    content = content.replace('executive-dashboard-pre-v2.png', 'executive-dashboard-pre-v3.png')
    content = content.replace('executive-dashboard-post-v2.png', 'executive-dashboard-post-v3.png')
    
    with open(path, 'w') as f:
        f.write(content)

shutil.copy('/Users/chandrahin/Desktop/google_projects/workplace_pulse/assets/screenshots/executive-dashboard-pre.png', 
            '/Users/chandrahin/Desktop/google_projects/workplace_pulse/assets/screenshots/executive-dashboard-pre-v3.png')
shutil.copy('/Users/chandrahin/Desktop/google_projects/workplace_pulse/assets/screenshots/executive-dashboard-post.png', 
            '/Users/chandrahin/Desktop/google_projects/workplace_pulse/assets/screenshots/executive-dashboard-post-v3.png')
shutil.copy('/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-pre.png', 
            '/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-pre-v3.png')
shutil.copy('/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-post.png', 
            '/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-post-v3.png')
