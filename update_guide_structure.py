...
new_content = """# WorkplacePulse User Guide
...
3. Click the **Sign in with Google** button in the top right corner.
...
*Figure 2: The post-login state showing your active User Profile, Demo Mode OFF, and live telemetry data.*
...
new_content_art = new_content.replace('./assets/screenshots/executive-dashboard-pre.png', '/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-pre-v4.png')
new_content_art = new_content_art.replace('./assets/screenshots/executive-dashboard-post.png', '/Users/chandrahin/.gemini/antigravity/brain/673d00df-4447-454a-9ef5-11112f2ddbf4/executive-dashboard-post-v5.png')
