...
def get_gemini_api_key() -> str:
    ...
    3. Returns None cleanly without blocking if running in demo/offline mode.
    """
    # 1. Local Fallback
    ...
    if not project_id and not os.environ.get("GOOGLE_APPLICATION_CREDENTIALS"):
        # Demo / Offline sandbox mode - don't block on network discovery
        return None
    ...
    try:
        ...
        logging.info(f"Secret Manager not available locally: {e}. Running in smart simulation mode.")
        return None
